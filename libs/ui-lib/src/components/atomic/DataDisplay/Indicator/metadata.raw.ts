...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: '子元素',
                    tip: 'children | Element that should have an indicator',
                },
            },
            {
                name: 'position',
                ...
                title: {
                    label: 'Position',
                    tip: 'position | Indicator position relative to child element',
                },
            },
            {
                name: 'offset',
                ...
                title: {
                    label: 'Offset',
                    tip: 'offset | Changes position offset, usually used when element has border-radius',
                },
            },
            {
                name: 'inline',
                ...
                title: {
                    label: 'Inline',
                    tip: 'inline | Determines whether indicator container should be an inline element',
                },
            },
            {
                name: 'size',
                ...
                title: {
                    label: '大小',
                    tip: 'size | Indicator width and height',
                },
            },
            {
                name: 'label',
            ...
            },
            {
                ...
                title: {
                    label: 'Radius',
                    tip: 'radius | Key of theme.radius or any valid CSS value to set border-radius, 1000rem by default',
                },
            },
            {
                name: 'color',
                ...
                title: {
                    label: '颜色',
                    tip: 'color | Color from theme.colors or any other valid CSS color value',
                },
            },
            {
                name: 'withBorder',
                ...
                title: {
                    label: 'WithBorder',
                    tip: 'withBorder | Determines whether indicator should have border',
                },
            },
            {
                name: 'disabled',
                ...
                title: {
                    label: 'Disabled',
                    tip: 'disabled | When component is disabled it renders children without indicator',
                },
            },
            {
                name: 'processing',
                ...
                title: {
                    label: 'Processing',
                    tip: 'processing | Indicator processing animation',
                },
            },
            {
                name: 'zIndex',
