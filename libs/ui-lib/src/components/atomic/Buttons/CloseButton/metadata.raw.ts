        ...
        props: [
            {
                ...
                title: {
                    label: '图标大小',
                    tip: 'iconSize | Width and height of X icon',
                },
            },
            {
            ...
            },
            {
                ...
                title: {
                    label: 'Variant',
                    tip: 'variant | Controls appearance, subtle by default',
                },
            },
            {
                name: 'color',
            ...
            },
            {
                ...
                title: {
                    label: 'Gradient',
                    tip: 'gradient | Gradient input, only used when variant="gradient", theme.defaultGradient by default',
                },
            },
            {
                name: 'radius',
            ...
            },
            {
                ...
                title: {
                    label: '大小',
                    tip: 'size | Predefined button size or any valid CSS value to set width and height',
                },
            },
            {
                name: 'loaderProps',
                ...
                title: {
                    label: 'LoaderProps',
                    tip: 'loaderProps | Props added to Loader component (only visible when `loading` prop is set)',
                },
            },
            {
                name: 'loading',
                ...
                title: {
                    label: 'Loading',
                    tip: 'loading | Indicates loading state',
                },
            },
            {
                name: 'disabled',
                ...
                title: {
                    label: 'Disabled',
                    tip: 'disabled | Indicates disabled state',
                },
            },
            {
                name: 'className',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "radius" | "loader" | "colorScheme" | "fontFamily" | "lineHeight" | "transitionTimingFunction" | "dir" | "primaryShade" | "focusRing" | "defaultRadius" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
