...
export default [
    {
        componentName: 'MantineContainer',
        title: '容器',
        devMode: 'proCode',
        npm: {
            package: '@app/mantine-components',
            version: '0.0.0',
            exportName: 'MantineContainer',
            main: 'libs/components/src/components/atomic/Layout/Container/component.tsx',
            destructuring: true,
            subName: '',
        },
        props: [
            ...
            },
            {
                ...
                title: {
                    label: '大小',
                    tip: 'size | Predefined container max-width or number for max-width',
                },
            },
            {
                name: 'fluid',
                ...
                title: {
                    label: 'Fluid',
                    tip: 'fluid | If fluid is set to true, size prop is ignored and Container can expand to 100% of width',
                },
            },
            {
                name: 'sizes',
