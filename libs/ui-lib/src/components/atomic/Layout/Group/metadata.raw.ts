...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                propType: {
                    type: 'oneOf',
                    value: ['left', 'right', 'center', 'apart'],
                },
                title: {
                    label: 'Position',
                    tip: 'position | Defines justify-content property',
                },
            },
            {
                name: 'noWrap',
                ...
                title: {
                    label: 'NoWrap',
                    tip: 'noWrap | Defined flex-wrap property',
                },
            },
            {
                name: 'grow',
                ...
                title: {
                    label: 'Grow',
                    tip: 'grow | Defines flex-grow property for each element, true -> 1, false -> 0',
                },
            },
            {
                name: 'spacing',
                ...
                title: {
                    label: 'Spacing',
                    tip: 'spacing | Space between elements',
                },
            },
            {
                name: 'align',
                ...
                title: {
                    label: 'Align',
                    tip: 'align | Defines align-items css property',
                },
            },
            {
                name: 'className',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "spacing" | "fontFamily" | "lineHeight" | "black" | "white" | "colorScheme" | "transitionTimingFunction" | "dir" | "primaryShade" | "focusRing" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
