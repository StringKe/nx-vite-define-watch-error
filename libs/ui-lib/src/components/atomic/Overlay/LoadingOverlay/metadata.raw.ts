...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: 'KeepMounted',
                    tip: 'keepMounted | If set loading overlay will not be unmounted from the DOM when it is hidden, display: none styles will be added instead',
                },
            },
            {
                name: 'loader',
                ...
                title: {
                    label: 'Loader',
                    tip: 'loader | Provide custom loader',
                },
            },
            {
                name: 'loaderProps',
                ...
                title: {
                    label: 'LoaderProps',
                    tip: 'loaderProps | Loader component props',
                },
            },
            {
                name: 'overlayOpacity',
                ...
                title: {
                    ...
                    tip: 'overlayOpacity | Sets overlay opacity',
                },
            },
            {
                name: 'overlayColor',
                ...
                title: {
                    label: 'Overlay颜色',
                    tip: 'overlayColor | Sets overlay color, defaults to theme.white in light theme and to theme.colors.dark[5] in dark theme',
                },
            },
            {
                name: 'overlayBlur',
                ...
                title: {
                    label: 'OverlayBlur',
                    tip: 'overlayBlur | Sets overlay blur',
                },
            },
            {
                name: 'zIndex',
                ...
                title: {
                    label: 'ZIndex',
                    tip: 'zIndex | Loading overlay z-index',
                },
            },
            {
                name: 'visible',
                ...
                title: {
                    label: 'Visible',
                    tip: 'visible | If visible overlay will take 100% width and height of first parent with relative position and overlay all of its content',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'transitionDuration | Animation duration in ms',
                },
            },
            {
            ...
            },
            {
                ...
                title: {
                    label: 'Radius',
                    tip: 'radius | Key of theme.radius or any valid CSS value to set border-radius, 0 by default',
                },
            },
            {
                name: 'className',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "loader" | "radius" | "fontFamily" | "lineHeight" | "black" | "white" | "colorScheme" | "transitionTimingFunction" | "dir" | "primaryShade" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
