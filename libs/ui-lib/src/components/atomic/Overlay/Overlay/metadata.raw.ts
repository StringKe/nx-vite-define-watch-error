...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: 'Opacity',
                    tip: 'opacity | Overlay background-color opacity 0–1, disregarded when gradient prop is set, 0.6 by default',
                },
            },
            {
                name: 'color',
                ...
                title: {
                    label: '颜色',
                    tip: 'color | Overlay background-color, #000 by default',
                },
            },
            {
                name: 'blur',
                ...
                title: {
                    label: 'Blur',
                    tip: 'blur | Overlay background blur, 0 by default',
                },
            },
            {
                name: 'gradient',
                ...
                title: {
                    label: 'Gradient',
                    tip: 'gradient | Changes overlay to gradient, if set color prop is ignored',
                },
            },
            {
                name: 'zIndex',
                ...
                title: {
                    label: 'ZIndex',
                    tip: 'zIndex | Overlay z-index, 200 by default',
                },
            },
            {
                name: 'radius',
            ...
            },
            {
                ...
                title: {
                    label: '子元素',
                    tip: 'children | Content rendered inside overlay',
                },
            },
            {
                name: 'center',
                ...
                title: {
                    label: 'Center',
                    tip: 'center | Determines whether content inside overlay should be vertically and horizontally centered, false by default',
                },
            },
            {
                name: 'fixed',
                ...
                title: {
                    label: '固定',
                    tip: 'fixed | Determines whether overlay should have fixed position instead of absolute, false by default',
                },
            },
            {
                name: 'className',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "radius" | "black" | "white" | "colorScheme" | "fontFamily" | "lineHeight" | "transitionTimingFunction" | "dir" | "primaryShade" | "focusRing" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
