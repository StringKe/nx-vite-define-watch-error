...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: '颜色',
                    tip: 'color | Code color and background from theme, defaults to gray in light theme and to dark in dark theme',
                },
            },
            {
                name: 'block',
                ...
                title: {
                    label: 'Block',
                    tip: 'block | True for code block, false for inline code',
                },
            },
            {
                name: 'className',
