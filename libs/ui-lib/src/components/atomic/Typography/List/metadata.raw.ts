...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: '子元素',
                    tip: 'children | <List.Item /> components only',
                },
            },
            {
                name: 'type',
            ...
            },
            {
                ...
                title: {
                    label: 'With内边距',
                    tip: 'withPadding | Include padding-left to offset list from main content',
                },
            },
            {
                name: 'size',
                ...
                title: {
                    label: '大小',
                    tip: 'size | Font size from theme or number to set value',
                },
            },
            {
                name: 'icon',
                ...
                title: {
                    label: '图标',
                    tip: 'icon | Icon that should replace list item dot',
                },
            },
            {
                name: 'spacing',
                ...
                title: {
                    label: 'Spacing',
                    tip: 'spacing | Spacing between items from theme or number to set value',
                },
            },
            {
                name: 'center',
                ...
                title: {
                    label: 'Center',
                    tip: 'center | Center items with icon',
                },
            },
            {
                name: 'listStyleType',
        ...
        props: [
            {
                ...
                title: {
                    label: '图标',
                    tip: 'icon | Icon to replace bullet',
                },
            },
            {
                name: 'children',
                    ...
                    value: [
                        {
                            ...
                            raw: '(instance: HTMLLIElement) => void',
                        },
                        'object',
                    ],
                },
