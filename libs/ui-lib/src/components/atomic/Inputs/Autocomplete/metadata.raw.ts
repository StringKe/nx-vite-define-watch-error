        ...
        props: [
            ...
            },
            {
                ...
                propType: {
                    ...
                    raw: '(item: AutocompleteItem) => void',
                },
                title: {
                    label: 'OnItemSubmit',
                    tip: 'onItemSubmit | Called when item from dropdown was selected',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'hoverOnSearchChange | Hovers the first result when input changes',
                },
            },
            {
                name: 'className',
