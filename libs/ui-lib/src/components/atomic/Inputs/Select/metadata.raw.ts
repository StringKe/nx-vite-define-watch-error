...
export default [
    {
        componentName: 'MantineSelect',
        title: '选择器',
        devMode: 'proCode',
        npm: {
            package: '@app/mantine-components',
            version: '0.0.0',
            exportName: 'MantineSelect',
            main: 'libs/components/src/components/atomic/Inputs/Select/component.tsx',
            destructuring: true,
            subName: '',
        },
        props: [
            ...
            },
            {
                ...
                title: {
                    label: 'Searchable',
                    tip: 'searchable | Set to true to enable search',
                },
            },
            {
                name: 'clearable',
            ...
            },
            {
                ...
                title: {
                    ...
                    tip: 'onSearchChange | Called each time search value changes',
                },
            },
            {
                name: 'searchValue',
            ...
            },
            {
                ...
                title: {
                    ...
                    tip: 'dropdownComponent | Change dropdown component, can be used to add native scrollbars',
                },
            },
            {
                name: 'selectOnBlur',
            ...
            },
            {
                ...
                title: {
                    label: 'AllowDeselect',
                    tip: 'allowDeselect | Allow deselecting items on click',
                },
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'FilterDataOnExactSearchMatch',
                    tip: 'filterDataOnExactSearchMatch | Should data be filtered when search value exactly matches selected item',
                },
            },
            {
            ...
            },
            {
                ...
                propType: {
                    ...
                    raw: '(value: string, item: SelectItem) => boolean',
                },
                title: {
                    label: 'Filter',
