...
export default [
    {
        componentName: 'MantinePasswordInput',
        title: '密码输入框',
        devMode: 'proCode',
        npm: {
            package: '@app/mantine-components',
            version: '0.0.0',
            exportName: 'MantinePasswordInput',
            main: 'libs/components/src/components/atomic/Inputs/PasswordInput/component.tsx',
            destructuring: true,
            subName: '',
        },
        props: [
            {
                ...
                title: {
                    label: 'ToggleTabIndex',
                    tip: 'toggleTabIndex | Toggle button tabIndex, set to 0 to make button focusable with tab key',
                },
            },
            {
                ...
                propType: 'object',
                title: {
                    label: 'VisibilityToggle图标',
                    tip: 'visibilityToggleIcon | Provide your own visibility toggle icon',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'visibilityToggleLabel | aria-label for visibility toggle button',
                },
            },
            {
                name: 'visible',
                ...
                title: {
                    label: 'Visible',
                    tip: 'visible | Determines whether input content should be visible (controlled)',
                },
            },
            {
                name: 'defaultVisible',
                ...
                title: {
                    ...
                    tip: 'defaultVisible | Determines whether input content should be visible (uncontrolled)',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'onVisibilityChange | Called when visibility changes',
                },
            },
            {
                name: 'className',
