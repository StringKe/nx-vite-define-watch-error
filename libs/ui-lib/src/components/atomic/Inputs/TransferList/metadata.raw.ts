        ...
        props: [
            ...
            },
            {
                ...
                propType: {
                    ...
                    raw: '(value: TransferListData) => void',
                },
                title: {
                    label: 'OnChange',
            ...
            },
            {
                ...
                title: {
                    ...
                    tip: 'initialSelection | Initial items selection',
                },
            },
            {
                name: 'itemComponent',
                ...
                title: {
                    label: 'ItemComponent',
                    tip: 'itemComponent | Custom item component',
                },
            },
            {
                name: 'searchValues',
                ...
                title: {
                    label: 'SearchValues',
                    tip: 'searchValues | Controlled search queries',
                },
            },
            {
                name: 'onSearch',
                ...
                title: {
                    label: 'OnSearch',
                    tip: 'onSearch | Called when one of the search queries changes',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'searchPlaceholder | Search fields placeholder',
                },
            },
            {
                name: 'nothingFound',
                ...
                title: {
                    label: 'NothingFound',
                    tip: 'nothingFound | Nothing found message',
                },
            },
            {
                name: 'placeholder',
                ...
                title: {
                    label: 'Placeholder',
                    tip: 'placeholder | Displayed when a list is empty and there is no search query',
                },
            },
            {
                name: 'filter',
                propType: {
                    ...
                    raw: '(query: string, item: TransferListItem) => boolean',
                },
                title: {
                    label: 'Filter',
                    tip: 'filter | Function to filter search results',
                },
            },
            {
                name: 'titles',
            ...
            },
            {
                ...
                title: {
                    label: 'List高度',
                    tip: 'listHeight | List items height',
                },
            },
            {
                name: 'listComponent',
                ...
                title: {
                    label: 'ListComponent',
                    tip: 'listComponent | Change list component, can be used to add custom scrollbars',
                },
            },
            {
                name: 'breakpoint',
                ...
                title: {
                    label: 'Breakpoint',
                    tip: 'breakpoint | Breakpoint at which list will collapse to single column layout',
                },
            },
            {
                name: 'radius',
            ...
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'ShowTransferAll',
                    tip: 'showTransferAll | Whether to hide the transfer all button',
                },
            },
            {
                name: 'limit',
                ...
                title: {
                    label: 'Limit',
                    tip: 'limit | Limit amount of items showed at a time',
                },
            },
            {
                name: 'transferIcon',
                ...
                title: {
                    label: 'Transfer图标',
                    tip: 'transferIcon | Change icon used for the transfer selected control',
                },
            },
            {
                name: 'transferAllIcon',
                propType: 'object',
                title: {
                    label: 'TransferAll图标',
                    tip: 'transferAllIcon | Change icon used for the transfer all control',
                },
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'TransferAllMatchingFilter',
                    tip: 'transferAllMatchingFilter | Whether to transfer only items matching {@link filter} when clicking the transfer all control',
                },
            },
            {
                name: 'className',
