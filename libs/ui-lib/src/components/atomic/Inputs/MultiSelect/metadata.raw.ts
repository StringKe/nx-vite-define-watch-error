        ...
        props: [
            {
                ...
                title: {
                    ...
                    tip: 'valueComponent | Component used to render values',
                },
            },
            {
                ...
                title: {
                    label: 'MaxDropdown高度',
                    tip: 'maxDropdownHeight | Maximum dropdown height',
                },
            },
            {
                name: 'searchable',
                ...
                title: {
                    label: 'Searchable',
                    tip: 'searchable | Enable items searching',
                },
            },
            {
                name: 'filter',
                propType: {
                    ...
                    raw: '(value: string, selected: boolean, item: SelectItem) => boolean',
                },
                title: {
                    label: 'Filter',
                    tip: 'filter | Function based on which items in dropdown are filtered',
                },
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'ClearSearchOnChange',
                    tip: 'clearSearchOnChange | Clear search value when item is selected',
                },
            },
            {
                name: 'clearable',
                ...
                title: {
                    label: 'Clearable',
                    tip: 'clearable | Allow to clear item',
                },
            },
            {
                name: 'disableSelectedItemFiltering',
                propType: 'bool',
                title: {
                    label: 'DisableSelectedItemFiltering',
                    tip: 'disableSelectedItemFiltering | Disable removing selected items from the list',
                },
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'ClearSearchOnBlur',
                    tip: 'clearSearchOnBlur | Clear search field value on blur',
                },
            },
            {
                name: 'onSearchChange',
                ...
                title: {
                    ...
                    tip: 'onSearchChange | Called each time search query changes',
                },
            },
            {
                name: 'searchValue',
                ...
                title: {
                    label: 'SearchValue',
                    tip: 'searchValue | Controlled search input value',
                },
            },
            {
                name: 'hoverOnSearchChange',
                propType: 'bool',
                title: {
                    label: 'HoverOnSearchChange',
                    tip: 'hoverOnSearchChange | Hovers the first result when search query changes',
                },
            },
            {
                name: 'creatable',
                ...
                title: {
                    label: 'Creatable',
                    tip: 'creatable | Allow creatable option',
                },
            },
            {
                name: 'getCreateLabel',
                propType: {
                    ...
                    raw: '(query: string) => ReactNode',
                },
                title: {
                    label: 'GetCreateLabel',
                    tip: 'getCreateLabel | Function to get create Label',
                },
            },
            {
                name: 'shouldCreate',
                propType: {
                    ...
                    raw: '(query: string, data: SelectItem[]) => boolean',
                },
                title: {
                    label: 'ShouldCreate',
                    tip: 'shouldCreate | Function to determine if create label should be displayed',
                },
            },
            {
                name: 'onCreate',
                propType: {
                    ...
                    raw: '(query: string) => string | SelectItem',
                },
                title: {
                    label: 'OnCreate',
                    tip: 'onCreate | Called when create option is selected',
                },
            },
            {
                ...
                propType: 'any',
                title: {
                    label: 'DropdownComponent',
                    tip: 'dropdownComponent | Change dropdown component, can be used to add custom scrollbars',
                },
            },
            {
                ...
                propType: 'number',
                title: {
                    label: 'MaxSelectedValues',
                    tip: 'maxSelectedValues | Limit amount of items selected',
                },
            },
            {
                name: 'selectOnBlur',
                ...
                title: {
                    label: 'SelectOnBlur',
                    tip: 'selectOnBlur | Select highlighted item on blur',
                },
            },
            {
            ...
            },
            {
                ...
                title: {
                    label: 'DefaultValue',
                    tip: 'defaultValue | Uncontrolled input defaultValue',
                },
            },
            {
                name: 'value',
                ...
                title: {
                    label: 'Value',
                    tip: 'value | Controlled input value',
                },
            },
            {
                name: 'nothingFound',
                ...
                title: {
                    label: 'NothingFound',
                    tip: 'nothingFound | Nothing found label',
                },
            },
            {
                name: 'onChange',
                ...
                title: {
                    label: 'OnChange',
                    tip: 'onChange | Controlled input onChange handler',
                },
            },
            {
                name: 'data',
                ...
                title: {
                    label: 'Data',
                    tip: 'data | Select data used to render items in dropdown',
                },
            },
            {
            ...
            },
            {
                ...
                title: {
                    label: 'Shadow',
                    tip: 'shadow | Dropdown shadow from theme or any value to set box-shadow',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'initiallyOpened | Initial dropdown opened state',
                },
            },
            {
                name: 'itemComponent',
                ...
                title: {
                    label: 'ItemComponent',
                    tip: 'itemComponent | Change item renderer',
                },
            },
            {
                name: 'onDropdownOpen',
                ...
                title: {
                    ...
                    tip: 'onDropdownOpen | Called when dropdown is opened',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'onDropdownClose | Called when dropdown is closed',
                },
            },
            {
                name: 'withinPortal',
            ...
            },
            {
                ...
                title: {
                    label: 'Limit',
                    tip: 'limit | Limit amount of items displayed at a time for searchable select',
                },
            },
            {
                name: 'zIndex',
            ...
            },
            {
                ...
                propType: {
                    type: 'oneOf',
                    value: ['top', 'bottom', 'flip'],
                },
                title: {
                    label: 'DropdownPosition',
                    tip: 'dropdownPosition | Dropdown positioning behavior',
                },
            },
            {
                ...
                propType: 'bool',
                title: {
                    label: 'SwitchDirectionOnFlip',
                    tip: 'switchDirectionOnFlip | Whether to switch item order and keyboard navigation on dropdown position flip',
                },
            },
            {
