...
export default [
    {
        componentName: 'MantineSegmentedControl',
        title: '分段控制器',
        devMode: 'proCode',
        npm: {
            package: '@app/mantine-components',
            version: '0.0.0',
            exportName: 'MantineSegmentedControl',
            main: 'libs/components/src/components/atomic/Inputs/SegmentedControl/component.tsx',
            destructuring: true,
            subName: '',
        },
        props: [
            ...
            },
            {
                ...
                title: {
                    label: 'Data',
                    tip: 'data | Data based on which controls are rendered',
                },
            },
            {
                name: 'value',
                ...
                title: {
                    label: 'Value',
                    tip: 'value | Current selected value',
                },
            },
            {
                name: 'disabled',
            ...
            },
            {
                ...
                title: {
                    label: 'Name',
                    tip: 'name | Name of the radio group, default to random id',
                },
            },
            {
                name: 'fullWidth',
                ...
                title: {
                    label: 'FullWidth',
                    tip: 'fullWidth | True if component should have 100% width',
                },
            },
            {
                name: 'color',
                ...
                title: {
                    label: '颜色',
                    tip: 'color | Active control color from theme.colors, defaults to white in light color scheme and theme.colors.dark[9] in dark',
                },
            },
            {
                name: 'size',
                ...
                title: {
                    label: '大小',
                    tip: 'size | Controls font-size, paddings and height',
                },
            },
            {
                name: 'radius',
            ...
            },
            {
                ...
                title: {
                    ...
                    tip: 'transitionDuration | Transition duration in ms, set to 0 to turn off transitions',
                },
            },
            {
                ...
                title: {
                    ...
                    tip: 'transitionTimingFunction | Transition timing function for all transitions, defaults to theme.transitionTimingFunction',
                },
            },
            {
                name: 'defaultValue',
            ...
            },
            {
                ...
                title: {
                    label: 'Orientation',
                    tip: 'orientation | Display Vertically',
                },
            },
            {
                name: 'readOnly',
                ...
                title: {
                    label: 'ReadOnly',
                    tip: 'readOnly | Determines whether the user can change value',
                },
            },
            {
                name: 'className',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "radius" | "transitionTimingFunction" | "fontFamily" | "lineHeight" | "black" | "white" | "colorScheme" | "dir" | "primaryShade" | "focusRing" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
