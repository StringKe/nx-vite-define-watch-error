...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                propType: {
                    ...
                    value: [
                        ...
                        {
                            type: 'oneOf',
                            value: ['outline', 'filled', 'light'],
                        },
                    ],
                },
                title: {
                    label: 'Variant',
                    tip: 'variant | Controls chip appearance, defaults to filled with dark theme and to outline in light theme',
                },
            },
            {
                name: 'children',
            ...
            },
            {
                ...
                title: {
                    label: 'Checked',
                    tip: 'checked | Checked state for controlled component',
                },
            },
            {
                name: 'defaultChecked',
                ...
                title: {
                    ...
                    tip: 'defaultChecked | Default value for uncontrolled component',
                },
            },
            {
                name: 'onChange',
                ...
                title: {
                    label: 'OnChange',
                    tip: 'onChange | Calls when checked state changes',
                },
            },
            {
                name: 'color',
                ...
                title: {
                    label: '颜色',
                    tip: 'color | Active color from theme, defaults to theme.primaryColor',
                },
            },
            {
                name: 'id',
                ...
                title: {
                    label: 'Id',
                    tip: 'id | Static id to bind input with label',
                },
            },
            {
                name: 'wrapperProps',
        ...
        props: [
            {
                ...
                title: {
                    label: 'Multiple',
                    tip: 'multiple | Allow multiple values to be selected at a time',
                },
            },
            {
                name: 'value',
            ...
            },
            {
                ...
                title: {
                    label: 'DefaultValue',
                    tip: 'defaultValue | Uncontrolled component initial value',
                },
            },
            {
                name: 'onChange',
                propType: {
                    ...
                    raw: '(value: T extends true ? string[] : string) => void',
                },
                title: {
                    label: 'OnChange',
