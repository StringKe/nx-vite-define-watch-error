        ...
        props: [
            {
                ...
                title: {
                    label: 'ValueFormat',
                    tip: 'valueFormat | Dayjs format to display input value, "MMMM YYYY" by default',
                },
            },
            {
                name: 'closeOnChange',
                ...
                title: {
                    label: 'CloseOnChange',
                    tip: 'closeOnChange | Determines whether dropdown should be closed when date is selected, not applicable when type="multiple", true by default',
                },
            },
            {
                name: 'dropdownType',
            ...
            },
            {
                ...
                title: {
                    label: 'MaxLevel',
                    tip: 'maxLevel | Max level that user can go up to (decade, year), defaults to decade',
                },
            },
            {
                name: 'defaultLevel',
