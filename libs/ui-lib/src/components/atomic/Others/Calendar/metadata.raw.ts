...
export default [
    {
        ...
        props: [
            ...
            },
            {
                ...
                title: {
                    label: 'Static',
                    tip: 'static | Determines whether days should be static, static days can be used to display month if it is not expected that user will interact with the component in any way',
                },
            },
            {
                name: 'translate',
                                                    ...
                                                    value: [
                                                        {
                                                            ...
                                                            propType: {
                                                                ...
                                                                raw: '(theme: Pick<MantineTheme, "dir" | "black" | "white" | "fontFamily" | "lineHeight" | "colorScheme" | "transitionTimingFunction" | "primaryShade" | "focusRing" | "defaultRadius" | ... 18 more ... | "focusRingStyles">) => CSSObject',
                                                            },
                                                        },
                                                        {
                                                            name: 'resetStyles',
            ...
            },
            {
                ...
                title: {
                    label: 'OnYearMouseEnter',
                    tip: 'onYearMouseEnter | Called when mouse enters year control',
                },
            },
            {
                ...
                title: {
                    label: 'OnMonthMouseEnter',
                    tip: 'onMonthMouseEnter | Called when mouse enters month control',
                },
            },
            {
                name: 'maxLevel',
            ...
            },
            {
                ...
                title: {
                    label: 'MinLevel',
                    tip: 'minLevel | Min level that user can go down to (decade, year, month), defaults to month',
                },
            },
            {
